...
define gui.main_menu_background = Movie(play="gui/main_menu.mkv")
...
init python:
    # Menambahkan pengaturan default untuk alignment
    gui.dialogue_text_xalign = 0.5  # Default: tengah horizontal
    gui.dialogue_yalign = 0.5  # Default: tengah vertikal
    gui.text_color = "#ffffff"  # Contoh warna teks default
