...
screen about():
    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            if gui.about:
                text "[gui.about!t]\n"
            text _("Gim ini dibuat dalam rangka pemenuhan tugas besar PKWN ITB 2024 Kelas __. Berikut adalah daftar anggota kelompok beserta dengan peran masing-masing dalam pembuatan gim ini!\n\n")
